...
|  09/09/2025   | [Hands-On with Coding Agents in QGIS and Earth Engine](https://github.com/ua-datalab/geospatial_2025/wiki/Session-2:-Coding-Agents-with-QGIS-and-Earth-Engine)  | The session will demonstrate two AI tools for autonomous geospatial analysis: <br/> Execute commands in QGIS with the chatbot Claude; Generate analysis code in Earth Engine using Google's Gemini. To follow along, please see the pre-session setup instructions [here].  |
